    ...
    return (
      <Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
        <SheetContent
          ...
          data-slot="sidebar"
          data-mobile="true"
          className="w-(--sidebar-width) bg-sidebar/70 backdrop-blur-2xl p-0 text-sidebar-foreground [&>button]:hidden"
          style={
            {
    ...
    >
      ...
      <div
        ...
        className={cn(
          ...
          state === "collapsed" ? "z-10" : "z-30 shadow-xl",
          // Adjust the padding and width for floating and inset variants based on state
          variant === "floating" || variant === "inset"
            ? state === "collapsed"
              ? "p-2 w-[calc(var(--sidebar-width-icon)+(--spacing(4))+2px)]"
              : "p-2 w-(--sidebar-width)"
            : state === "collapsed"
              ? "w-(--sidebar-width-icon) border-r"
      ...
      >
        <div
          ...
          className="flex size-full flex-col bg-sidebar/70 backdrop-blur-2xl overflow-hidden rounded-xl  ring-1 dark:ring-sidebar-border/20 ring-sidebar-border/80 "
        >
          {children}
        </div>
      </div>
